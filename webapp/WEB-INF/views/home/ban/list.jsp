				...
				<div id="main" class="col-xs-10">
					...
					<div id="content-body-area" class="container-fluid row">
						<div class="row">
							...
							<a href="${pageContext.request.contextPath}/myclass/createForm" style="color: #fff;">
							...
							<div class="row">
								<div class="col-xs-11" style="width: 97%;">
									<table class="tableFontSize table table-striped table-hover table-bordered" style="margin-left: 15px;">
										...
										<ul class="pagination">
											<li><c:choose>
													<c:when test="${param.page <=1 or empty param.page }">
														<a href="${pageContext.request.contextPath }/myclass/list?page=1" aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
														</a>
													</c:when>
													<c:otherwise>
														<a href="${pageContext.request.contextPath }/myclass/list?page=${param.page -1}" aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
														</a>
													</c:otherwise>
												</c:choose></li>

											<c:forEach var="page" begin="${pMap.startPage }" end="${pMap.endPage }" step="1">
												<c:choose>
													<c:when test="${param.page eq page or (empty param.page and page==1)}">

														<li class="active"><a href="${pageContext.request.contextPath }/myclass/list?page=${page}&search=${param.search}">${page }</a></li>

													</c:when>
													<c:otherwise>

														<li><a href="${pageContext.request.contextPath }/myclass/list?page=${page}&search=${param.search}">${page }</a></li>
											...
											<li><c:choose>
													<c:when test="${param.page >= pMap.lastPage }">
														<a href="${pageContext.request.contextPath }/myclass/list?page=${pMap.lastPage}" aria-label="Next"> <span aria-hidden="true">&raquo;</span>
														</a>
													</c:when>
													<c:otherwise>
														<a href="${pageContext.request.contextPath }/myclass/list?page=${param.page +1}" aria-label="Next"> <span aria-hidden="true">&raquo;</span>
														</a>
													</c:otherwise>
												</c:choose></li>
										</ul>
