										...
										<div class="col-xs-9">
											<div class="row col-xs-9">
												<div class="col-sm-4 problemType">
													<a href="${pageContext.request.contextPath }/myclass/problem/multipleChoice"><button type="button"
															class="btn btn-warning">객관식</button></a>
												</div>
												<div class="col-sm-4 problemType">
													<a href="${pageContext.request.contextPath }/myclass/problem/ox"><button type="button" class="btn btn-info">OX문제</button></a>
												</div>
												<div class="col-sm-4 problemType">
													<a href="${pageContext.request.contextPath }/myclass/problem/subjective"><button type="button" class="btn btn-success">주관식</button></a>
												</div>
											</div>
											<!-- //row -->
												...
												<div class="col-xs-9" id="make-problem">
													<form action="#" method="post">
														<div class="form-group">
															<input type="text" class="form-control" value="역사시험" placeholder="문제 제목을 입력해주세요.">
														</div>
														<div class="form-group">
															<input type="text" class="form-control" value="사진 속 인물은 이순신 장군이다." placeholder="문제를 입력해주세요.">
														</div>
														<div class="form-group">
